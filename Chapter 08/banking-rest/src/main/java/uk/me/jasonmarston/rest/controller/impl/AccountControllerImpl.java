...
import uk.me.jasonmarston.event.bean.impl.Message;
...
public class AccountControllerImpl implements AccountController {
    ...
    public ResponseEntity<?> depositFunds(
		...
		if(deposit.getAmount() == null || deposit.getDescription() == null) {
			return ResponseEntity
					.badRequest()
					.body(new Message("Invalid Transaction"));
		}
	...
	public ResponseEntity<?> getDeposit(
		...
		if(deposit == null) {
   			return ResponseEntity
   					.badRequest()
   					.body(new Message("Invalid Deposit"));
		}
	...
	public ResponseEntity<?> getWithdrawal(
			...
			if(withdrawal == null) {
	   			return ResponseEntity
	   					.badRequest()
	   					.body(new Message("Invalid Withdrawal"));
			}
