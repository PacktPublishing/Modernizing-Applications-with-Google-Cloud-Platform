angular.module('service.account').
	service('Account', ['$resource', function($resource) {
		...
		this.setToken = function(newToken) {
			if(token !== newToken) {
				token = newToken;
				account = $resource('bank/account/:accountId', {accountId: '@accountId'}, {
					getAll: {
						method: 'GET',
						isArray: true,
						headers: {
				...
				withdrawal = $resource('bank/account/:accountId/withdrawal', {accountId: '@accountId'}, {
					withdrawFunds: {
						method: 'POST',
						params: {accountId: '@accountId'},
						headers: {
				...
				deposit = $resource('bank/account/:accountId/deposit', {accountId: '@accountId'}, {
					depositFunds: {
						method: 'POST',
						params: {accountId: '@accountId'},
						headers: {
				...
				transaction = $resource('bank/account/:accountId/transaction/:transactionId', {accountId: '@accountId', transactionId: '@transactionId'}, {
					getAll: {
						method: 'GET',
						params: {accountId: '@accountId'},
						isArray: true,
